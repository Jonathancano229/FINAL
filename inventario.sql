...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-11-2022 a las 21:27:17
...
CREATE TABLE `activo` (
  ...
  `sede` varchar(50) COLLATE utf8_spanish2_ci NOT NULL,
...
(2, 'deyson', 'guerrero', 'dguerrero', '$2y$10$ywQX5oZuHxwVSri.ysrPqOFGImY4V1sbBOJtn2cuKPSJwT/ZtuWvS', 'deyson312@gmail.com');
...
ALTER TABLE `activo`
  ...
  ADD CONSTRAINT `activo_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`usuario_id`);
COMMIT;
